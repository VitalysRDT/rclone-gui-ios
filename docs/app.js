(() => {
  ...
  var VERSIONS = [
    { v: "2.1.2", current: true, date: { fr: "Ao\xFBt 2026", en: "August 2026" }, items: [
      { fr: "Domaines CDN personnalis\xE9s : un pr\xE9fixe de chemin facultatif permet de retirer le nom du bucket renvoy\xE9 par Qiniu Kodo et d\u2019autres stockages compatibles S3.", en: "Custom CDN domains: an optional path prefix can remove the bucket name returned by Qiniu Kodo and other S3-compatible storage providers." },
      { fr: "Annulation PhotoSync : arr\xEAtez une synchronisation en cours, videz l\u2019index et la file locale, puis changez librement les albums ou le dossier de destination \u2014 les fichiers d\xE9j\xE0 envoy\xE9s restent sur le remote.", en: "Cancel PhotoSync: stop an active sync, clear its local index and queue, then freely change the selected albums or destination folder \u2014 files already uploaded remain on the remote." },
      { fr: "Albums PhotoSync sur Mac : la s\xE9lection se met \xE0 jour imm\xE9diatement et seules les photos des albums choisis sont index\xE9es et synchronis\xE9es, y compris apr\xE8s une ancienne indexation compl\xE8te.", en: "PhotoSync albums on Mac: selections now update immediately, and only photos from the chosen albums are indexed and synced, including after an earlier full-library index." },
      { fr: "Pause PhotoSync fiabilis\xE9e : elle interrompt d\xE9sormais l\u2019export Photos et le lot rclone en cours sans mettre en pause vos autres transferts.", en: "More reliable PhotoSync pause: it now interrupts the current Photos export and rclone batch without pausing your other transfers." }
    ] },
    { v: "2.1.1", date: { fr: "Ao\xFBt 2026", en: "August 2026" }, items: [
      { fr: "Dossiers chiffr\xE9s : correction d\u2019un probl\xE8me o\xF9 Rclone GUI ou Fichiers pouvait afficher un dossier crypt vide ou incomplet alors que ses fichiers \xE9taient toujours pr\xE9sents.", en: "Encrypted folders: fixed an issue where Rclone GUI or Files could show a crypt folder as empty or incomplete even though its files were still present." },
      { fr: "Envoi depuis Fichiers : les fichiers d\xE9pos\xE9s dans un dossier chiffr\xE9 sont maintenant pr\xE9par\xE9s dans une zone temporaire s\xE9curis\xE9e, puis le dossier s\u2019actualise automatiquement.", en: "Uploads from Files: files dropped into an encrypted folder are now prepared in secure temporary storage, then the folder refreshes automatically." },
      { fr: "Fichiers plus r\xE9actif : les anciennes demandes sont nettoy\xE9es, les doublons regroup\xE9s et une erreur de listing ne peut plus faire passer un dossier pour vide.", en: "More responsive Files integration: old requests are cleaned up, duplicates are coalesced, and a listing error can no longer make a folder look empty." },
      { fr: "Liens publics : pour les remotes compatibles, g\xE9n\xE9rez un lien via rclone ou utilisez un domaine CDN personnalis\xE9, puis copiez ou partagez l\u2019URL en texte brut, Markdown ou HTML.", en: "Public links: for supported remotes, generate a link through rclone or use a custom CDN domain, then copy or share the URL as plain text, Markdown, or HTML." },
      { fr: "Ajout plus visible sur iPhone : le nouveau bouton \xAB + \xBB permet de cr\xE9er un dossier ou d\u2019envoyer des fichiers, des dossiers, des photos et des vid\xE9os directement depuis le navigateur.", en: "More visible add action on iPhone: the new \u201C+\u201D button creates a folder or uploads files, folders, photos, and videos right from the browser." },
      { fr: "Chinois simplifi\xE9 : l\u2019int\xE9gralit\xE9 du catalogue de cha\xEEnes est maintenant disponible en zh-Hans, avec une terminologie harmonis\xE9e dans les nouveaux parcours.", en: "Simplified Chinese: the full string catalog is now available in zh-Hans, with consistent terminology throughout the new flows." },
      { fr: "Achat \xE0 vie : l\u2019app distingue d\xE9sormais l\u2019acc\xE8s permanent d\u2019un abonnement renouvelable et rappelle qu\u2019un abonnement Apple existant doit \xEAtre annul\xE9 s\xE9par\xE9ment.", en: "Lifetime purchase: the app now distinguishes permanent access from a renewable subscription and reminds you that an existing Apple subscription must be cancelled separately." }
    ] },
    { v: "2.1", date: { fr: "Juillet 2026", en: "July 2026" }, items: [
      { fr: "Modifier un remote : un nouvel \xE9cran \xAB G\xE9rer les remotes \xBB (R\xE9glages) permet de corriger un r\xE9glage ou de r\xE9autoriser un compte OAuth expir\xE9 sans tout recr\xE9er \u2014 vos mots de passe et jetons existants restent masqu\xE9s.", en: 'Edit a remote: a new "Manage remotes" screen (Settings) lets you fix a setting or re-authorize an expired OAuth account without recreating everything \u2014 your existing passwords and tokens stay hidden.' },
      { fr: "Remote Lens : jetez un \u0153il \xE0 un fichier distant sans le t\xE9l\xE9charger \u2014 aper\xE7u d'image avec ses donn\xE9es EXIF, et premi\xE8re page des PDF, r\xE9cup\xE9r\xE9s par lecture partielle.", en: "Remote Lens: peek at a remote file without downloading it \u2014 image preview with its EXIF data, and PDF first page, fetched through partial reads." },
      { fr: "Suppression r\xE9par\xE9e : supprimer un fichier ou un dossier, ou le mettre \xE0 la corbeille, fonctionne \xE0 nouveau \u2014 l'action restait sans effet.", en: "Deletion fixed: deleting a file or folder, or moving it to the trash, works again \u2014 the action silently did nothing." }
    ] },
    { v: "2.0", date: { fr: "Juillet 2026", en: "July 2026" }, items: [
      { fr: "Transparence \xAB 0 appel maison \xBB : un nouvel \xE9cran (R\xE9glages \u2192 Transparence) prouve en direct que l'app ne contacte aucun serveur maison \u2014 et le binaire natif rclone est d\xE9sormais reproductible et v\xE9rifiable par un tiers.", en: "Transparency, zero phone-home: a new screen (Settings \u2192 Transparency) proves live that the app contacts no home server \u2014 and the native rclone binary is now reproducible and independently verifiable." },
      { fr: "Handoff : transf\xE9rez votre configuration chiffr\xE9e d'un appareil \xE0 l'autre par QR code, AirDrop ou fichier.", en: "Handoff: move your encrypted configuration between devices via QR code, AirDrop or file." },
      { fr: "Ghost Vault : sauvegarde chiffr\xE9e de votre configuration rclone dans l'un de vos propres remotes.", en: "Ghost Vault: encrypted backup of your rclone configuration into one of your own remotes." },
      { fr: "T\xE9l\xE9chargements plus intelligents : gestion automatique selon le r\xE9seau, la batterie et la temp\xE9rature, et t\xE9l\xE9chargements de dossiers fiabilis\xE9s (fini les gels sur iCloud Drive).", en: "Smarter downloads: automatic management based on network, battery and temperature, plus reliable folder downloads (no more freezes on iCloud Drive)." },
      { fr: "iCloud Drive r\xE9par\xE9 : l'ajout de votre compte iCloud fonctionne \xE0 nouveau \u2014 connectez-vous avec votre mot de passe Apple ID habituel, l'app vous demande ensuite votre code de v\xE9rification (2FA).", en: "iCloud Drive fixed: adding your iCloud account works again \u2014 sign in with your regular Apple ID password, then the app asks for your verification code (2FA)." },
      { fr: "Synchro photo : les photos ignor\xE9es (supprim\xE9es, acc\xE8s partiel, illisibles) sont enfin visibles, avec un bouton \xAB R\xE9essayer les ignor\xE9es \xBB.", en: 'Photo sync: skipped photos (deleted, partial access, unreadable) are finally visible, with a "Retry skipped" button.' }
    ] },
