...
const VERSIONS = [
  ...
  { v:'1.9.1', date:{ fr:'Juin 2026', en:'June 2026' }, items:[
    { fr:'Correctif : au premier lancement (notamment sur macOS), la création du tout premier remote via l\'assistant pouvait échouer avec l\'erreur « Catalogue rclone indisponible ». C\'est corrigé — l\'assistant « Nouveau remote » fonctionne dès le premier lancement.', en:'Fix: on first launch (especially on macOS), creating your very first remote through the wizard could fail with a "rclone catalog unavailable" error. This is now fixed — the "New remote" wizard works right away.' },
  ] },
  { v:'1.9', date:{ fr:'Juin 2026', en:'June 2026' }, items:[
    ...
    { fr:'Mini-lecteur audio persistant : une barre « en cours de lecture » avec pochette reste visible pendant que vous naviguez ; touchez-la pour le lecteur plein écran (grande pochette, barre de progression, file de lecture).', en:'Persistent audio mini-player: a "now playing" bar with artwork stays visible while you browse; tap it for the full-screen player (large artwork, scrubber, play queue).' },
    ...
    { fr:'Performances : application nettement plus fluide — moins de gels, navigation, vignettes et transferts optimisés.', en:'Performance: a noticeably smoother app — fewer freezes, with optimized browsing, thumbnails and transfers.' },
  ] },
